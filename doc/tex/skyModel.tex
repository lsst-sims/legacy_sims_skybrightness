...
\begin{figure}
  ...
  \caption{Example of zodiacal light interpolated from ESO templates. XXX-increase label font sizes \label{fig:zodiacal}}
\end{figure}
...
\begin{figure}
  ...
  \caption{Examples of the sky brightness components that are only dependent on airmass.  XXX-make this plot prettier\label{fig:merged}}
\end{figure}
...
XXX--add plots showing the dark-time residuals as a function of time-of-year and time-of-night for each filter.  See if there are any obvious residuals.

XXX-Need a statement on how good the model is (0.1 mag, 0.5 mag etc)

XXX-List what the ESO dark sky brightesses are for the LSST filters.  
